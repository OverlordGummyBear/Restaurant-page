function loadMain(){
    ...
    mainDiv.classList = "main neon-border-dark";
    ...
    reviewDiv.classList = "main-info-div review-container neon-border-light";
    hourInfoDiv.classList = "main-info-div hour-info-container neon-border-light";
    locationDiv.classList = "main-info-div location-container neon-border-light";
    ...
    //Append three main divs to the mainDiv
    mainDiv.append(h1, reviewDiv, hourInfoDiv, locationDiv);
